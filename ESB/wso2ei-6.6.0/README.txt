...
Welcome to the WSO2 EI 6.6.0 release
...
==================================
1. Extract  wso2ei-6.6.0.zip and go to the extracted directory/bin.
...
========================================================
1. Extract wso2ei-6.6.0.zip and go to the extracted directory.
2. Go to wso2ei-6.6.0/wso2 directory.
3. Go to appropriate runtime directory (analytics/broker/business-process ) /bin.
4. Execute wso2server.sh or wso2server.bat.
5. Optionally, you can start the runtimes using scripts located at wso2ei-6.6.0/bin directory.
